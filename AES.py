# AES-128 Implementation (Single Block) — Educational
# This follows FIPS-197 structure: SubBytes, ShiftRows, MixColumns, AddRoundKey
...
def inv_sub_bytes(state): return [InvSbox[b] for b in state]
...
def key_expansion(key):
    ...
    return [w[16*i:16*(i+1)] for i in range(Nr+1)]
...
# --- Test with NIST AES-128 vector ---
plain  = [0x32,0x43,0xf6,0xa8,0x88,0x5a,0x30,0x8d,0x31,0x31,0x98,0xa2,0xe0,0x37,0x07,0x34]
key    = [0x2b,0x7e,0x15,0x16,0x28,0xae,0xd2,0xa6,0xab,0xf7,0x97,0x75,0x46,0x20,0x63,0xed]
...
print("Dec   :",' '.join(f"{x:02x}" for x in dec))
print("Matches expected vector:", cipher == [0x39,0x25,0x84,0x1d,0x02,0xdc,0x09,0xfb,0xdc,0x11,0x85,0x97,0x19,0x6a,0x0b,0x32])
